        ...
        <div class="bg-white shadow-lg rounded-lg p-8 w-[1096px]">
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="flex-1 text-center">
                    <div
                        :class="[
                            'step-circle w-12 h-12 rounded-full flex items-center justify-center font-semibold text-lg mx-auto',
                ...
                <!-- Line after Step 1 -->
                <div :class="['flex-grow h-px mx-4', currentStep >= 2 ? 'bg-[#fba42c]' : 'bg-gray-300']"></div>
                <div class="flex-1 text-center">
                    <div
                        :class="[
                            'step-circle w-12 h-12 rounded-full flex items-center justify-center font-semibold text-lg mx-auto',
                ...
                <!-- Line after Step 2 -->
                <div :class="['flex-grow h-px mx-4', currentStep === 3 ? 'bg-[#fba42c]' : 'bg-gray-300']"></div>
                <div class="flex-1 text-center">
                    <div
                        :class="[
                            'step-circle w-12 h-12 rounded-full flex items-center justify-center font-semibold text-lg mx-auto',
            ...
            >
                ...
                <DropDownInput
                    ...
                    class="w-full"
                >
                    <p class="label-3 text-neutral-500">Gender</p>
            ...
            <div
                v-if="currentStep === 2"
                class="grid grid-cols-3 gap-5 mb-10"
            >
                <FloatingLabelInput
                    v-model="houseNumber"
                    id="houseNumber"
            ...
            >
                <DropDownInput
                    ...
                    class="w-full"
                >
                    <p class="label-3 text-neutral-500">Card Type</p>
                    <i class="bx bxs-down-arrow"></i>
                </DropDownInput>
                <FloatingLabelInput
                    v-model="nameOnCard"
            ...
            <div class="flex justify-end gap-2 mt-20">
                <button
                    v-if="currentStep > 1"
                    @click="prevStep"
                    class="px-[33px] py-[15px] bg-[#fba42c] text-white hover:bg-orange-600 transition duration-300 font-semibold label-4 rounded-[5px] cursor-pointer"
                >
                    Back
                </button>
